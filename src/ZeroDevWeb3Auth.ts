...
import { ZeroDevWeb3AuthInitOptions, ChainId, ZeroDevWeb3AuthOptions, ZeroDevWeb3AuthEvents } from "./types.js";
...
import { isMobileDevice } from "./utilities.js";
...
class ZeroDevWeb3Auth extends Web3AuthNoModal {
    ...
    async login(loginProvider: LoginProvider, extra?: {jwt: string} ): Promise<IProvider | null> {
